...
define VSFTPD_ENABLE_TCPWRAPPERS
	$(SED) 's/.*VSF_BUILD_TCPWRAPPERS/#define VSF_BUILD_TCPWRAPPERS/' $(@D)/builddefs.h
endef
...
ifeq ($(BR2_PACKAGE_TCP_WRAPPERS),y)
VSFTPD_DEPENDENCIES += tcp-wrappers host-pkgconf
VSFTPD_LIBS += -lwrap
VSFTPD_POST_CONFIGURE_HOOKS += VSFTPD_ENABLE_TCPWRAPPERS
endif
