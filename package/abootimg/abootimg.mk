...
define HOST_ABOOTIMG_INSTALL_CMDS
	...
	$(INSTALL) -m 0755 $(@D)/abootimg-pack-initrd $(HOST_DIR)/usr/bin/abootimg-pack-initrd
	$(INSTALL) -m 0755 $(@D)/abootimg-unpack-initrd $(HOST_DIR)/usr/bin/abootimg-unpack-initrd
endef
